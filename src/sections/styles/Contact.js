export const CONTAINER = "px-10 py-5 md:pt-5 bg-[#2E2E2E] "
export const md_CONTAINER = " md:px-24 md:pb-12"

export const TITLE = "text-5xl font-bold text-center text-white"
...
export const LOGO_CONTAINER = "w-8 h-8 md:w-12 md:h-12 rounded"
